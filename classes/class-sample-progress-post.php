...
/**
 * dt_sample_progress_post
 *
 * @class dt_sample_progress_post
 * @version	0.1
 * @since 0.1
...
class dt_sample_progress_post {
    ...
    /**
     * dt_sample_progress_post The single instance of dt_sample_progress_post.
     * @var 	object
     * @access  private
     * @since 	0.1
     */
    ...
    /**
     * Main dt_sample_progress_post Instance
     *
     * Ensures only one instance of dt_sample_progress_post is loaded or can be loaded.
     *
     * @since 0.1
     * @static
     * @return dt_sample_progress_post instance
     */
