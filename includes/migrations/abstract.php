 ...
 *  "DT_Demo_Data_Migration_xxxx", where xxxx is the migration number. For
 *  example:
 *
 *      class DT_Demo_Data_Migration_0002 extends DT_Demo_Data_Migration {
 *          // ...
 *      }
 *
 *  See the documentation for DT_Demo_Data_Migration_Engine.
 *
 */
abstract class DT_Demo_Data_Migration {
    ...
    /**
     * @throws \DT_Demo_Data_Migration_Test_Exception Table $name not as expected, see error log.
     */
    protected function test_expected_tables() {
        ...
        foreach ( $expected_tables as $name => $expected_table ) {
            ...
            if ( $got_table !== $expected_table ) {
                ...
                throw new DT_Demo_Data_Migration_Test_Exception( "Table $name not as expected, see error log" );
            }
        }
    }
...
/**
 * Class DT_Demo_Data_Migration_Test_Exception
 */
class DT_Demo_Data_Migration_Test_Exception extends Exception {
}
